<script lang="ts">
	...
	import { getMotion, initSmoothScroll } from '$lib/motion/smoothScroll';
...
<section bind:this={root} class="relative min-h-[100dvh] overflow-hidden grain">
	...
	<div class="relative container-page flex min-h-[100dvh] flex-col justify-end pb-16 pt-44">
		<div class="max-w-5xl">
			<p
				class="mb-5 font-mono text-xs tracking-[0.16em] text-paper uppercase drop-shadow-[0_1px_8px_rgba(6,24,32,0.85)] sm:text-sm"
				data-hero-sub
			>
				{site.edition} · Lyons, Colorado
			</p>
